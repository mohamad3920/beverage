...
import com.assignment.onlineShop.validation.ValidBirthdate;
...
public class RegistrationForm {
    ...
    public WebUser toUser(PasswordEncoder passwordEncoder, String role) {
        return new WebUser(username, passwordEncoder.encode(password), fullName, phoneNumber, birthDate, role);
    }
}
